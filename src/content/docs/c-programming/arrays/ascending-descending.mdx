...
description: "Sorting an array in ascending and descending order in C."
difficulty: "Intermediate"
tags: ["C", "Array", "Sorting"]
---
...
This program sorts a list of given numbers in both ascending and descending order using a simple Bubble Sort approach.
