---
title: "Prime or Composite Check"
description: "Check if a given number is prime or composite."
tags: ["C Programming", "Logic", "Math"]
---
...
This program determines if a provided positive integer is a Prime number (only divisible by 1 and itself) or a Composite number.
