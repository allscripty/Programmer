---
title: "Sum via Pointers"
description: "Add two numbers using pointers."
tags: ["C Programming", "Pointers", "Math"]
---
...
This program calculates the sum of two variables using indirection—storing the memory addresses of the variables in pointer variables (`*ptr`), and extracting the values dynamically via dereferencing.
