---
title: "Formatted I/O (fprintf & fscanf)"
description: "Write and read student records using fprintf and fscanf."
tags: ["C Programming", "File Handling", "I/O", "Loops"]
---
...
This program demonstrates writing multiple items (roll numbers, names, percentages) to a file using formatted output `fprintf()` and subsequently reading and displaying them in a tabular format using `fscanf()`.
